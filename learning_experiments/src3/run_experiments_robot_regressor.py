#!/usr/bin/env python
"""
title           :run_experiments_robot.py
...
BASE_DIR = "multi_result_robot_regressor_exp"
...
if __name__ == "__main__":
	for exp_no in range(n_experiments):
		...
		params = ["python", "src/train_mvae_robot_regressor.py"] + list(chain(*list(zip(list(config.keys()), list(config.values())))))
